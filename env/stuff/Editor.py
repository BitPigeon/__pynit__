...
class Editor(ScrolledText):
    ...
    def __init__(self):
        super().__init__()
        self.highlighter_dict = {"keyword": "SteelBlue1", "number": "", "string": "", "definition": "", "comment": "", "selection": "", "builtin": "SteelBlue3"}
        self.keywords = ["False", "True", "and", "or", "not", "break", "continue", "class", "def", "if", "elif", "else", "for", "while", "in", "is", "None", "lambda", "return", "yield", "async" "nonlocal", "global", "import", "from", "raise", "pass", "with", "finally", "try", "except", "or", "and", "elif", "await", "assert"]
